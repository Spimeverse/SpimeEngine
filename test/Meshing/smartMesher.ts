import { SampleDimensions, SmartMesher , SdfSampler } from "../../src/Meshing";
...
export function TestSmartMesher() 
{        
    describe('smart SDF mesher', () => {
    ...
    it('creates a cube mesh', () => {
        ...
        const extracted = SmartMesher(fieldArray,dims,field,meshVerticies,meshFaces);
